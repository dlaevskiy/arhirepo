...
class TestSorting(unittest.TestCase):
    ...
    def test34(self):
        ...
        for el in sort_to_polish(['sin', '(', 'pi', '/', 2.0, '^', 1.0, ')', '+', 'log', '(', 1.0, '*', 4.0,
                                  '+', 2.0, '^', 2.0, '+', 1.0, ',', 3.0, '^', 2.0, ')']):
            list_.append(el)
        self.assertEqual(list_, ['pi', 2.0, 1.0, '^', '/', 'sin', 1.0, 4.0, '*', 2.0, 2.0, '^', '+',
                                 1.0, '+', ',', 3.0, 2.0, '^', 'log', '+'])
    ...
    def test61(self):
        list_ = []
        for el in sort_to_polish(['log', '(', 8.0, ',', 2.0, ')']):
            list_.append(el)
        self.assertEqual(list_, [8.0, ',', 2.0, 'log'])

    def test62(self):
        list_ = []
        for el in sort_to_polish(['log', '(', 2.7, ')']):
            list_.append(el)
        self.assertEqual(list_, [2.7, 'log'])

    def test63(self):
        list_ = []
        for el in sort_to_polish(['(', 'log', '(', 8.0, ',', 2.0, ')', '-', 1.0, ')', '-', 2.0]):
            list_.append(el)
    ...
    def test66(self):
        list_ = []
        for el in sort_to_polish(['log', '(', 8.0, ',', 2.0, ')', '*', 'log', '(', 16.0, ',', 2.0, ')']):
            list_.append(el)
    ...
    def test70(self):
        list_ = []
        for el in sort_to_polish(['log', '(', 100.0, ',', 10.0, ')']):
            list_.append(el)
    ...
    def test73(self):
        list_ = []
        for el in sort_to_polish(['log10', '(', 100.0, ')', '-', 1.0]):
            list_.append(el)
        self.assertEqual(list_, [100.0, 'log10', 1.0, '-'])

    def test74(self):
        list_ = []
        for el in sort_to_polish(['log10', '(', 100.0, ')', '*', 'log10', '(', 1000.0, ')']):
            list_.append(el)
        self.assertEqual(list_, [100.0, 'log10', 1000.0, 'log10', '*'])

    def test75(self):
        list_ = []
        for el in sort_to_polish(['sin', '(', 'log10', '(', 100.0, ')', '*', 'log10', '(', 1000.0, ')', ')']):
            list_.append(el)
    ...
    def test77(self):
        list_ = []
        for el in sort_to_polish(['pow', '(', 2.0, ',', 4.0, ')']):
            list_.append(el)
    ...
    def test79(self):
        list_ = []
        for el in sort_to_polish(['(', 'pow', '(', 2.0, ',', 4.0, ')', '-', 1.0, ')', '-', 2.0]):
            list_.append(el)
    ...
    def test82(self):
        list_ = []
        for el in sort_to_polish(['pow', '(', 2.0, ',', 4.0, ')', '*', 'pow', '(', 2.0, ',', 3.0, ')']):
            list_.append(el)
