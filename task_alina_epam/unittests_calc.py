...
class TestCalcing(unittest.TestCase):
    ...
    def test2(self):
        self.assertEqual(6.0 - (-13.0), calc([6.0, 0.0, 13.0, '-', '-']))

    def test3(self):
        self.assertEqual(1.0---1.0, calc([1.0, 1.0, '-']))

    def test4(self):
        self.assertEqual(-+---+-1.0, calc([0.0, 1.0, '-']))

    def test5(self):
        self.assertEqual(1.0 + 2.0 * 2.0, calc([1.0, 2.0, 2.0, '*', '+']))

    def test6(self):
        self.assertEqual(1.0 + (2.0 + 3.0 * 2.0) * 3.0, calc([1.0, 2.0, 3.0, 2.0, '*', '+', 3.0, '*', '+']))

    def test7(self):
        self.assertEqual(10.0 * (2.0 + 1.0), calc([10.0, 2.0, 1.0, '+', '*']))
    ...
    def test13(self):
        self.assertEqual(math.sin(math.pi / 2.0), calc(['pi', 2.0, '/', 'sin']))

    def test14(self):
        self.assertEqual(math.log10(100.0), calc([100.0, 'log10']))

    def test15(self):
        self.assertEqual(math.sin(math.pi / 2.0) * 111 * 6, calc(['pi', 2.0, '/', 'sin', 111.0, '*', 6.0, '*']))

    def test16(self):
        self.assertEqual(2.0 * math.sin(math.pi / 2.0), calc([2.0, 'pi', 2.0, '/', 'sin', '*']))
    ...
    def test22(self):
        self.assertEqual(1.0 + 2.0 * 3.0 == 1.0 + 2.0 * 3.0, calc([1.0, 2.0, 3.0, '*', '+',
                                                                   1.0, 2.0, 3.0, '*', '+', '==']))

    def test23(self):
        self.assertEqual(math.e ** 5.0 >= math.e ** 5.0 + 1.0, calc(['e', 5.0, '^', 'e', 5.0, '^', 1.0, '+', '>=']))

    def test24(self):
        self.assertEqual(1.0 + 2.0 * 4.0 / 3.0 + 1.0 != 1.0 + 2.0 * 4.0 / 3.0 + 2.0,
                         calc([1.0, 2.0, 4.0, '*', 3.0, '/', '+', 1.0, '+', 1.0, 2.0, 4.0, '*',
                               3.0, '/', '+', 2.0, '+', '!=']))

    # Common tests
    def test25(self):
        self.assertEqual((100.0), calc([100.0]))

    def test26(self):
        self.assertEqual(666.0, calc([666.0]))
    ...
    def test31(self):
        self.assertEqual(math.e ** 34.0, calc(['e', 34.0, '^']))
    ...
    # Self-made cases
    def test52(self):
        self.assertEqual(100.0/3.0, calc([100.0, 3.0, '/']))
    ...
    def test56(self):
        self.assertEqual(math.sin(math.sin(1.0)), calc([1.0, 'sin', 'sin']))

    def test57(self):
        self.assertEqual(math.sin(math.sin(1.0))+1.0+math.sin(1.0),
                         calc([1.0, 'sin', 'sin', 1.0, '+', 1.0, 'sin', '+']))

    def test58(self):
        self.assertEqual(abs(-3.0), calc([0.0, 3.0, '-', 'abs']))
    ...
    def test72(self):
        self.assertEqual(-math.log10(100.0), calc([0.0, 100.0, 'log10', '-']))

    def test73(self):
        self.assertEqual(math.log10(100.0)-1.0, calc([100.0, 'log10', 1.0, '-']))

    def test74(self):
        self.assertEqual(math.log10(100.0)*math.log10(1000.0), calc([100.0, 'log10', 1000.0, 'log10', '*']))

    def test75(self):
        self.assertEqual(math.sin(math.log10(100.0)*math.log10(1000.0)),
                         calc([100.0, 'log10', 1000.0, 'log10', '*', 'sin']))
    ...
    def test86(self):
        self.assertEqual(-(-13.0), calc([0.0, 0.0, 13.0, '-', '-']))

    def test87(self):
        self.assertEqual(-(13.0), calc([0.0, 13.0, '-']))

    def test88(self):
        self.assertEqual(1.0*-13.0, calc([1.0, 0.0, 13.0, '-', '*']))
    ...
    def test92(self):
        self.assertEqual(-1.0-(-1.0), calc([0.0, 1.0, '-', 0.0, 1.0, '-', '-']))
