...
from task_alina_epam.math_parser_v1 import process_unary_operations
...
class TestProcessUnaryOperations(unittest.TestCase):
    ...
    def test28(self):
        list_ = process_unary_operations([6.0, '-', '(', '-', 13.0, ')'])
    ...
    def test31(self):
        list_ = process_unary_operations(['sin', '(', '-', 'cos', '(', '-', 'sin', '(', 3.0, ')', '-', 'cos', '(', '-',
    ...
    def test32(self):
        list_ = process_unary_operations([10.0, '*', 'e', '^', 0.0, '*', 'log10', '(', 0.4, '-', 5.0, '/', '-', 0.1,
                                          '-', 10.0, ')', '-', '-', 'abs', '(', '-', 53.0, '/', 10.0, ')', '+', '-',
                                          5.0])
